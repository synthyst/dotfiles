...
'-f+[Available variables\: {command}, {directory}, {duration}, {user}, {host}, {author}, {intent}, {exit}, {time}, {session}, and {uuid} Example\: --format "{time} - \[{duration}\] - {directory}\$\\t{command}"]:FORMAT:_default' \
'--format=[Available variables\: {command}, {directory}, {duration}, {user}, {host}, {author}, {intent}, {exit}, {time}, {session}, and {uuid} Example\: --format "{time} - \[{duration}\] - {directory}\$\\t{command}"]:FORMAT:_default' \
'-c[]' \
'--cwd[]' \
'-s[]' \
'--session[]' \
...
'--timezone=[Display the command time in another timezone other than the configured default]:TIMEZONE:_default' \
'--tz=[Display the command time in another timezone other than the configured default]:TIMEZONE:_default' \
'-f+[Available variables\: {command}, {directory}, {duration}, {user}, {host}, {author}, {intent}, {time}, {session}, {uuid} and {relativetime}. Example\: --format "{time} - \[{duration}\] - {directory}\$\\t{command}"]:FORMAT:_default' \
'--format=[Available variables\: {command}, {directory}, {duration}, {user}, {host}, {author}, {intent}, {time}, {session}, {uuid} and {relativetime}. Example\: --format "{time} - \[{duration}\] - {directory}\$\\t{command}"]:FORMAT:_default' \
'--human[]' \
'--cmd-only[Show only the text of the command]' \
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
...
'--search-mode=[Allow overriding search mode over config]:SEARCH_MODE:(prefix full-text fuzzy skim daemon-fuzzy)' \
...
'*--author=[Filter by author. Supports \$all-user (non-agents), \$all-agent, or literal names. Can be specified multiple times]:AUTHOR:_default' \
...
'--page=[Page Size How many records to upload at once. Defaults to 100]:PAGE:_default' \
...
'-t+[The tag to push (eg, '\''history'\''). Defaults to all tags]:TAG:_default' \
'--tag=[The tag to push (eg, '\''history'\''). Defaults to all tags]:TAG:_default' \
'--page=[Page Size How many records to download at once. Defaults to 100]:PAGE:_default' \
...
'--last=[Use the last command as the script content Optionally specify a number to use the last N commands]::LAST:_default' \
...
'-h[Print help]' \
'--help[Print help]' \
'::shell -- Shell to generate integration for; defaults to "auto":_default' \
&& ret=0
;;
(inline)
_arguments "${_arguments_options[@]}" : \
...
(help)
_arguments "${_arguments_options[@]}" : \
":: :_atuin__pty-proxy__help_commands" \
"*::: :->help" \
&& ret=0
...
(pty-proxy)
_arguments "${_arguments_options[@]}" : \
":: :_atuin__help__pty-proxy_commands" \
"*::: :->pty-proxy" \
&& ret=0
...
(( $+functions[_atuin__account__help__link_commands] )) ||
_atuin__account__help__link_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__account__link_commands] )) ||
_atuin__account__link_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__ai__help_commands] )) ||
_atuin__ai__help_commands() {
    local commands; commands=(
'init:Initialize shell integration' \
'inline:Inline completion mode with small TUI overlay' \
...
(( $+functions[_atuin__ai__help__help_commands] )) ||
_atuin__ai__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'atuin ai help help commands' commands "$@"
}
(( $+functions[_atuin__ai__help__init_commands] )) ||
_atuin__ai__help__init_commands() {
    local commands; commands=()
    _describe -t commands 'atuin ai help init commands' commands "$@"
}
(( $+functions[_atuin__ai__help__inline_commands] )) ||
_atuin__ai__help__inline_commands() {
    local commands; commands=()
    _describe -t commands 'atuin ai help inline commands' commands "$@"
}
(( $+functions[_atuin__ai__init_commands] )) ||
_atuin__ai__init_commands() {
    local commands; commands=()
    _describe -t commands 'atuin ai init commands' commands "$@"
}
(( $+functions[_atuin__ai__inline_commands] )) ||
_atuin__ai__inline_commands() {
    local commands; commands=()
    _describe -t commands 'atuin ai inline commands' commands "$@"
}
(( $+functions[_atuin__config_commands] )) ||
_atuin__config_commands() {
    local commands; commands=(
...
(( $+functions[_atuin__config__get_commands] )) ||
_atuin__config__get_commands() {
    local commands; commands=()
    _describe -t commands 'atuin config get commands' commands "$@"
}
(( $+functions[_atuin__config__help_commands] )) ||
_atuin__config__help_commands() {
    local commands; commands=(
'get:Get a configuration value from your config.toml file or after defaults and overrides are applied' \
'set:Set a configuration value in your config.toml file' \
...
(( $+functions[_atuin__config__help__get_commands] )) ||
_atuin__config__help__get_commands() {
    local commands; commands=()
    _describe -t commands 'atuin config help get commands' commands "$@"
}
(( $+functions[_atuin__config__help__help_commands] )) ||
_atuin__config__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'atuin config help help commands' commands "$@"
}
(( $+functions[_atuin__config__help__print_commands] )) ||
_atuin__config__help__print_commands() {
    local commands; commands=()
    _describe -t commands 'atuin config help print commands' commands "$@"
}
(( $+functions[_atuin__config__help__set_commands] )) ||
_atuin__config__help__set_commands() {
    local commands; commands=()
    _describe -t commands 'atuin config help set commands' commands "$@"
}
(( $+functions[_atuin__config__print_commands] )) ||
_atuin__config__print_commands() {
    local commands; commands=()
    _describe -t commands 'atuin config print commands' commands "$@"
}
(( $+functions[_atuin__config__set_commands] )) ||
_atuin__config__set_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__daemon__help_commands] )) ||
_atuin__daemon__help_commands() {
    local commands; commands=(
'start:Start the daemon server' \
'status:Show the daemon'\''s current status' \
...
(( $+functions[_atuin__daemon__help__help_commands] )) ||
_atuin__daemon__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon help help commands' commands "$@"
}
(( $+functions[_atuin__daemon__help__restart_commands] )) ||
_atuin__daemon__help__restart_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon help restart commands' commands "$@"
}
(( $+functions[_atuin__daemon__help__start_commands] )) ||
_atuin__daemon__help__start_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon help start commands' commands "$@"
}
(( $+functions[_atuin__daemon__help__status_commands] )) ||
_atuin__daemon__help__status_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon help status commands' commands "$@"
}
(( $+functions[_atuin__daemon__help__stop_commands] )) ||
_atuin__daemon__help__stop_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon help stop commands' commands "$@"
}
(( $+functions[_atuin__daemon__restart_commands] )) ||
_atuin__daemon__restart_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon restart commands' commands "$@"
}
(( $+functions[_atuin__daemon__start_commands] )) ||
_atuin__daemon__start_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon start commands' commands "$@"
}
(( $+functions[_atuin__daemon__status_commands] )) ||
_atuin__daemon__status_commands() {
    local commands; commands=()
    _describe -t commands 'atuin daemon status commands' commands "$@"
}
(( $+functions[_atuin__daemon__stop_commands] )) ||
_atuin__daemon__stop_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__help__account__link_commands] )) ||
_atuin__help__account__link_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__help__ai_commands] )) ||
_atuin__help__ai_commands() {
    local commands; commands=(
'init:Initialize shell integration' \
'inline:Inline completion mode with small TUI overlay' \
...
(( $+functions[_atuin__help__ai__init_commands] )) ||
_atuin__help__ai__init_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help ai init commands' commands "$@"
}
(( $+functions[_atuin__help__ai__inline_commands] )) ||
_atuin__help__ai__inline_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help ai inline commands' commands "$@"
}
(( $+functions[_atuin__help__config_commands] )) ||
_atuin__help__config_commands() {
    local commands; commands=(
'get:Get a configuration value from your config.toml file or after defaults and overrides are applied' \
'set:Set a configuration value in your config.toml file' \
...
(( $+functions[_atuin__help__config__get_commands] )) ||
_atuin__help__config__get_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help config get commands' commands "$@"
}
(( $+functions[_atuin__help__config__print_commands] )) ||
_atuin__help__config__print_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help config print commands' commands "$@"
}
(( $+functions[_atuin__help__config__set_commands] )) ||
_atuin__help__config__set_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__help__daemon__restart_commands] )) ||
_atuin__help__daemon__restart_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help daemon restart commands' commands "$@"
}
(( $+functions[_atuin__help__daemon__start_commands] )) ||
_atuin__help__daemon__start_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help daemon start commands' commands "$@"
}
(( $+functions[_atuin__help__daemon__status_commands] )) ||
_atuin__help__daemon__status_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help daemon status commands' commands "$@"
}
(( $+functions[_atuin__help__daemon__stop_commands] )) ||
_atuin__help__daemon__stop_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__help__history__tail_commands] )) ||
_atuin__help__history__tail_commands() {
    local commands; commands=()
    _describe -t commands 'atuin help history tail commands' commands "$@"
}
(( $+functions[_atuin__help__hook_commands] )) ||
_atuin__help__hook_commands() {
    local commands; commands=(
...
(( $+functions[_atuin__help__hook__install_commands] )) ||
_atuin__help__hook__install_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__help__pty-proxy_commands] )) ||
_atuin__help__pty-proxy_commands() {
    local commands; commands=(
...
(( $+functions[_atuin__help__pty-proxy__init_commands] )) ||
_atuin__help__pty-proxy__init_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__help__setup_commands] )) ||
_atuin__help__setup_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__history__help__tail_commands] )) ||
_atuin__history__help__tail_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__history__tail_commands] )) ||
_atuin__history__tail_commands() {
    local commands; commands=()
    _describe -t commands 'atuin history tail commands' commands "$@"
}
(( $+functions[_atuin__hook_commands] )) ||
_atuin__hook_commands() {
    local commands; commands=(
'install:Install hooks for an AI agent to capture commands in atuin history' \
'help:Print this message or the help of the given subcommand(s)' \
...
(( $+functions[_atuin__hook__help_commands] )) ||
_atuin__hook__help_commands() {
    local commands; commands=(
'install:Install hooks for an AI agent to capture commands in atuin history' \
'help:Print this message or the help of the given subcommand(s)' \
...
(( $+functions[_atuin__hook__help__help_commands] )) ||
_atuin__hook__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'atuin hook help help commands' commands "$@"
}
(( $+functions[_atuin__hook__help__install_commands] )) ||
_atuin__hook__help__install_commands() {
    local commands; commands=()
    _describe -t commands 'atuin hook help install commands' commands "$@"
}
(( $+functions[_atuin__hook__install_commands] )) ||
_atuin__hook__install_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__pty-proxy_commands] )) ||
_atuin__pty-proxy_commands() {
    local commands; commands=(
'init:Print shell code to initialize atuin pty-proxy on shell startup' \
'help:Print this message or the help of the given subcommand(s)' \
...
(( $+functions[_atuin__pty-proxy__help_commands] )) ||
_atuin__pty-proxy__help_commands() {
    local commands; commands=(
'init:Print shell code to initialize atuin pty-proxy on shell startup' \
'help:Print this message or the help of the given subcommand(s)' \
...
(( $+functions[_atuin__pty-proxy__help__help_commands] )) ||
_atuin__pty-proxy__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'atuin pty-proxy help help commands' commands "$@"
}
(( $+functions[_atuin__pty-proxy__help__init_commands] )) ||
_atuin__pty-proxy__help__init_commands() {
    local commands; commands=()
    _describe -t commands 'atuin pty-proxy help init commands' commands "$@"
}
(( $+functions[_atuin__pty-proxy__init_commands] )) ||
_atuin__pty-proxy__init_commands() {
    local commands; commands=()
...
(( $+functions[_atuin__setup_commands] )) ||
_atuin__setup_commands() {
    local commands; commands=()
